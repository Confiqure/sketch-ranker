...
const sketches = [
  ...
  {
    collection: 'Season 1, Episode 3: It’s the Cigars You Smoke That Are Going to Give You Cancer',
    title: 'Which Hand',
  ...
  {
    collection: 'Season 2, Episode 5: Didn’t you say there was gonna be five people at this table?',
    title: 'Parking Lot',
...
async function seedSketches() {
  ...
  try {
    ...
    console.log('Sketches have been successfully loaded into the database.')
  } catch (error) {
